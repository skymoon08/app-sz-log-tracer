package com.wayue.tracer.boot.springmvc.configuration;

import com.wayue.tracer.boot.configuration.SzTracerAutoConfiguration;
import com.wayue.tracer.boot.springmvc.properties.OpenTracingSpringMvcProperties;
import com.wayue.tracer.plugins.springmvc.SpringMvcSzTracerFilter;
...
@ConditionalOnProperty(prefix = "com.wayue.tracer.plugins.springmvc", value = "enable", matchIfMissing = true)
