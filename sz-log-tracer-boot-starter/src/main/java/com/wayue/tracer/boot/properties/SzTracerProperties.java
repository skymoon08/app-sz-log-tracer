package com.wayue.tracer.boot.properties;
...
import com.wayue.tracer.core.reporter.stat.manager.SzTracerStatisticReporterManager;
import org.springframework.boot.context.properties.ConfigurationProperties;

import java.util.HashMap;
import java.util.Map;

import static com.wayue.tracer.core.configuration.SzTracerConfiguration.DEFAULT_LOG_RESERVE_DAY;
...
public class SzTracerProperties {
    ...
    /**
     * json output : com.wayue.tracer.jsonOutput=true,
     */
