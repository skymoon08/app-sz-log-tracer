...
import com.wayue.tracer.core.reporter.common.CommonTracerManager;
import com.wayue.tracer.core.reporter.facade.Reporter;
...
public class SzTracerSpan implements Span {
     ...
     * <p>
     * 2.As a client: need to be built by {@link SzTracer.SzTracerSpanBuilder#start()}
     *
     * @param szTracer            szTracer
     * @param startTime           startTime
     ...
     * @param tags                tags
     */
    public SzTracerSpan(SzTracer szTracer, long startTime,
