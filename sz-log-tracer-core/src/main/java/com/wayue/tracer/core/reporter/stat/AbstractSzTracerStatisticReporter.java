package com.wayue.tracer.core.reporter.stat;
...
import com.wayue.tracer.core.reporter.stat.manager.SzTracerStatisticReporterCycleTimesManager;
...
import com.wayue.tracer.core.reporter.stat.model.StatValues;
...
public abstract class AbstractSzTracerStatisticReporter implements SzTracerStatisticReporter {
     ...
     * {@link SzTracerStatisticReporterManager#DEFAULT_CYCLE_SECONDS}
     */
