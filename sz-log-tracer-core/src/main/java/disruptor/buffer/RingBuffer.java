package disruptor.buffer;

import disruptor.dsl.ProducerType;
import disruptor.event.*;
...
public final class RingBuffer<E> extends RingBufferFields<E> implements Cursored, EventSequencer<E>, EventSink<E> {
    ...
    /**
     * Add the specified gating sequences to this instance of the   They will
    ...
    /**
     * @see EventSink#tryPublishEvent(EventTranslator) (EventTranslator)
     */
    @Override
    ...
    /**
     * @see EventSink#publishEvent(EventTranslator) (EventTranslatorOneArg, Object)
     * EventSink#publishEvent(EventTranslatorOneArg, A)
     */
    @Override
     ...
     * EventSink#tryPublishEvent(EventTranslatorOneArg, A)
     */
    @Override
     ...
     * EventSink#publishEvent(EventTranslatorTwoArg, A, B)
     */
    @Override
     ...
     * EventSink#tryPublishEvent(EventTranslatorTwoArg, A, B)
     */
    @Override
     ...
     * EventSink#publishEvent(EventTranslatorThreeArg, A, B, C)
     */
    @Override
     ...
     * EventSink#tryPublishEvent(EventTranslatorThreeArg, A, B, C)
     */
    @Override
     ...
     * EventSink#publishEvents(EventTranslatorOneArg, A[])
     */
    @Override
     ...
     * EventSink#publishEvents(EventTranslatorOneArg, int, int, A[])
     */
    @Override
     ...
     * EventSink#tryPublishEvents(EventTranslatorOneArg, A[])
     */
    @Override
     ...
     * EventSink#tryPublishEvents(EventTranslatorOneArg, int, int, A[])
     */
    @Override
     ...
     * EventSink#publishEvents(EventTranslatorTwoArg, A[], B[])
     */
    @Override
     ...
     * EventSink#publishEvents(EventTranslatorTwoArg, int, int, A[], B[])
     */
    @Override
     ...
     * EventSink#tryPublishEvents(EventTranslatorTwoArg, A[], B[])
     */
    @Override
     ...
     * EventSink#tryPublishEvents(EventTranslatorTwoArg, int, int, A[], B[])
     */
    @Override
     ...
     * EventSink#publishEvents(EventTranslatorThreeArg, A[], B[], C[])
     */
    @Override
     ...
     * EventSink#publishEvents(EventTranslatorThreeArg, int, int, A[], B[], C[])
     */
    @Override
     ...
     * EventSink#tryPublishEvents(EventTranslatorThreeArg, A[], B[], C[])
     */
    @Override
     ...
     * EventSink#tryPublishEvents(EventTranslatorThreeArg, int, int, A[], B[], C[])
     */
    @Override
    public <A, B, C> boolean tryPublishEvents(EventTranslatorThreeArg<E, A, B, C> translator,
                                              int batchStartsAt, int batchSize, A[] arg0, B[] arg1,
