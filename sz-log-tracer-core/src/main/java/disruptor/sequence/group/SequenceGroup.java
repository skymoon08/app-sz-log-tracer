package disruptor.sequence.group;


import disruptor.sequence.Cursored;
...
public final class SequenceGroup extends Sequence {
     ...
     * initialisation.  Use {@link SequenceGroup#addWhileRunning(disruptor.Cursored, Sequence)}
     *
     * @param sequence to be added to the aggregate.
     * @see  SequenceGroup#addWhileRunning(disruptor.Cursored, Sequence)
     */
