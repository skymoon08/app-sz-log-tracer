 ...
 * dependent {@link disruptor.event.EventProcessor}s for processing a data structure
 */
public interface SequenceBarrier {
    ...
    /**
     * Alert the {@link disruptor.event.EventProcessor}s of a status change and stay in this status until cleared.
     */
    void alert();
